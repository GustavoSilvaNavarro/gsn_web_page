  ...
  return (
    <section id="hero" className="flex flex-col items-center text-center mb-20 md:mb-32">
      <SpringElement>
        <div
          draggable={false}
          // Border and background of the image container
      ...
      <h1
        className="text-4xl md:text-6xl font-extrabold
                     ...
                     leading-tight mb-4 animate-fade-in-up-large">
        Hey, I&apos;m <span className="text-blue-600 dark:text-blue-400">{personalInfo.name}</span>.
      </h1>
      <p
        className="text-xl md:text-2xl
                    text-gray-700 dark:text-gray-300
                    max-w-3xl mb-8 animate-fade-in-up-large delay-200 text-justify text-pretty">
        {personalInfo.profile}
      </p>
      <a
        href="#experience"
        // Button styles (assuming you want the same color button in both modes, or you can adjust)
        className="bg-blue-600 hover:bg-blue-700
                   text-white font-bold py-3 px-8 rounded-lg
                   shadow-lg transition-all duration-300 transform hover:scale-105
                   animate-fade-in-up-large delay-400">
        View My Work
      </a>
    </section>
  );
